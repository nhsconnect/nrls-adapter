...
public class ConsumerController {
	...
	public ResponseEntity<?> getPointers(@RequestParam(name = "sessionId", required = true) String sessionId,
        ...
        auditEntity.setConsumerRequestData(RequestType.CONSUMER, 
                nhsNumber, 
                userId, 
                sessionId, 
        ...
        ResponseEntity response = new ResponseEntity<>(new EprRequest(sessionId, userId, nhsNumber), HttpStatus.OK);
